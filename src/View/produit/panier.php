<?php
if ($estConnecte) {
    $commander ="frontController.php?action=passerCommande&controller=commande";
} //rajouter le message flash ?>
                        ...
                        <div class="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                            <div class="flex-1 overflow-y-auto py-6 px-4 sm:px-6">
                                <div class="flex items-start justify-between">
                                    <h2 class="text-lg font-medium text-gray-900" id="slide-over-title">Panier d'achats</h2>
                                                    ...
                                                    <div class="ml-4 flex flex-1 flex-col">
                                                        <div>
                                                            <div class="flex justify-between text-base font-medium text-gray-900">
                                                                ...
                                                                <p class="ml-4"><?php echo htmlspecialchars($produit->getPrix()) ?> €/p.</p>
                                                            </div>
                                                        </div>
