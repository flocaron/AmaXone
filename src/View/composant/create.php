                    ...
                    <div class=" flex flex-col gap-6 bg-white px-4 py-5 sm:p-6">
                        ...
                        <div class="flex flex-col gap-6">
                            <div>
                                ...
                                <div class="mt-1">
                                    <textarea id="about" name="description" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"></textarea>
                                </div>
                            </div>
